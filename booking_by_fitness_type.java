public class booking_by_fitness_type extends javax.swing.JFrame {
    public booking_by_fitness_type() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        main_heading.setText("Booking Types");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Body_Sculpt bs = new Body_Sculpt();
        bs.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new booking_by_fitness_type().setVisible(true);
            }
        });
    }
