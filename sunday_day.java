...
public class sunday_day extends javax.swing.JFrame {
    static String[][] sunday_day_array = new String[5][7];
    static int j=0;
    public sunday_day() {
        initComponents();
    }
    ...
    public void set_7()
    {
       JOptionPane.showMessageDialog(this,"Name     : "+this.sunday_day_array[j-1][0]+"\nAge      : "+this.sunday_day_array[(j-1)][1]+"\nMobile   : "+this.sunday_day_array[(j-1)][2]+"\nAddress  : "+this.sunday_day_array[j-1][3]+"\nExercise : "+this.sunday_day_array[j-1][4]+"\nDay      : "+this.sunday_day_array[j-1][5]+"\nAmount      : "+this.sunday_day_array[j-1][6]);
    }
            ...
            try
            {
                if(Integer.parseInt(age)>0 && Integer.parseInt(mobile)>0 )
                {
                    if(Long.parseLong(mobile)>=100000000 && Long.parseLong(mobile)<=999999999)
                    {
                        ...
                        if(j<5)
                        {
                            this.sunday_day_array[j][0]=name;
                            this.sunday_day_array[j][1]=age;
                            this.sunday_day_array[j][2]=mobile;
                            this.sunday_day_array[j][3]=address;
                            this.sunday_day_array[j][4]=exercise;
                            this.sunday_day_array[j][5]="Saturday";
                            if(exercise.equals("SPIN"))
                                this.sunday_day_array[j][6]="1000/-";
                            else
                                this.sunday_day_array[j][6]="500/-";
